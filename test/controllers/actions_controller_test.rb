...
class ActionsControllerTest < ActionController::TestCase
  ...
  test "should create action" do
    assert_difference('Action.count') do
      post :create, action: { amt: @action.amt, challenge_id: @action.challenge_id, description: @action.description, enabled: @action.enabled, name: @action.name, subtype: @action.subtype }
    end
  ...
  test "should update action" do
    patch :update, id: @action, action: { amt: @action.amt, challenge_id: @action.challenge_id, description: @action.description, enabled: @action.enabled, name: @action.name, subtype: @action.subtype }
    assert_redirected_to action_path(assigns(:action))
  end
